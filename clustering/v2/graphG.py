...
def build_graph():
    ...
    json_file = os.path.join(script_dir, "posets_n4.json")
    ...
    if isinstance(hasse_results, dict):
        ...
        raise TypeError("posets_n4.json")
    ...
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_file_csv = os.path.join(script_dir, "final_graph_adjacency-posets_n4.csv")
    ...
    output_file_reduced_csv = os.path.join(script_dir, "final_graph_adjacency-posets_n4_transitive_reduction.csv")
    ...
    output_file_shortest_paths = os.path.join(script_dir, "shortest_path_distances-posets_n4.csv")
    ...
    output_file_shortest_paths = os.path.join(script_dir, "shortest_path_directed-posets_n4.csv")
    df_shortest_paths.to_csv(output_file_shortest_paths)
    ...
    output_file_reachability_matrix = os.path.join(script_dir, "reachability_matrix-posets_n4.csv")
