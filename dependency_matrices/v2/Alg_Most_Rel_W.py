...
CSV_FILE = os.path.join(script_dir, "sequence_of_sets_formattedNewV2.csv")
OUTPUT_FILE = os.path.join(script_dir, "event_pair_ordering_ratiosNewV2.csv")
