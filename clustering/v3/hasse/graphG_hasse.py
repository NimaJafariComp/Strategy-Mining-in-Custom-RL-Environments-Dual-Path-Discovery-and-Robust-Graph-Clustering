...
def build_graph():
    ...
    json_file = os.path.join(script_dir, "hasse_diagrams_n5.json") #connected hasse only
    ...
    if isinstance(hasse_results, dict):
        ...
        raise TypeError("hasse_diagrams_n5.json")
    ...
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_file_csv = os.path.join(script_dir, "final_graph_adjacency-hasse_n5.csv")
    ...
    output_file_reduced_csv = os.path.join(script_dir, "final_graph_adjacency-hasse_n5_transitive_reduction.csv")
    ...
    mat_j = G.nodes[343]['matrix']
    mat_i = G.nodes[725]['matrix']
    # mat_z = G.nodes[49]['matrix']
    # mat_x = G.nodes[11]['matrix']
    # mat_y = G.nodes[92]['matrix']
    print(mat_j)
    print(mat_i)
    # print(mat_z)
    # print(mat_x)
    # print(mat_y)
    # common = find_common_descendants(G_reduced, [343, 725])
    # print("Common descendants of 343, 725:", common)
    ...
    # output_file_shortest_paths = os.path.join(script_dir, "shortest_path_distances-hasse_n5.csv")
    ...
    # output_file_shortest_paths = os.path.join(script_dir, "shortest_path_directed-hasse_n5.csv")
    # df_shortest_paths.to_csv(output_file_shortest_paths)
    ...
    # output_file_reachability_matrix = os.path.join(script_dir, "reachability_matrix-hasse_n5.csv")
